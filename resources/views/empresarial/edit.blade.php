...
@section('contenido')
  ...
  @else
      ...
      <div align="center">
        <form method="POST"  style="width: 90%;" action="{{route('empresarial.update', $empresarial->id)}}" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              ...
              <div class="col-md-9"><input class="form-control" type="text" name="titulo" value="{{$empresarial->title}}">
            ...
            <div class="col-md-9">
              <input class="form-control" type="text" name="resumen" value="{{$empresarial->summary}}">
            ...
            <div class="col-md-3">  
              <select class="form-control" name="nombreEditor" required>
                 @foreach($listUsers as $user) 
                  @if($empresarial->nameEditor === $user->name.' '.$user->lastName)       
            ...
            <div class="col-md-3">  
              <select class="form-control" name="tipogaleria" required>
                @foreach($listTipoGaleria as $tipoGeleria)     
                  @if($empresarial->idTipoGaleria == $tipoGeleria->id)    
            ...
            <div class="col-md-9">
                <textarea rows="15" class="form-control"  name="contenido">{{$empresarial->contentempresarial->content}}  
                </textarea>
