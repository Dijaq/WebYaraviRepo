...
@section('contenido')
	...
	<div class="row">
		<div class="col-md-12">
			<div style="margin-top: 15px; margin-bottom: 15px; font-size: 30px; font-family: Gremoria; font-weight: 600; text-align: center; color: #6E6E6E" >Actualidad</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-9">
				...
				<div class="col-md-6" style="margin-bottom: 15px;">
					<article>
						<div class="picture left" style="width:100%; position: relative;"> 
							...
							<img src="{{asset('storage/'.$new->dirImagePortada)}}" style="width:100%; height: 240px;" alt="No se pudo cargar" /> <br />
