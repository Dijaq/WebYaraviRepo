					...
					<article>
						<div class="picture left" style="width:100%; position: relative;"> 
							...
							<div class="redes_etiqueta">
								<a target="_blank" href={{'https://www.facebook.com/sharer/sharer.php?u='.$urlServidor.'empresarial/'.$empresarial->titleUrl.'&amp;src=sdkpreparse'}} ><i style=" position: absolute; right: 5px; top: 5px;   text-align: center;">
									<img src="https://www.facebook.com/images/fb_icon_325x325.png" class="img-responsive" width="22px">
								</i>
								</a>
							</div>
							<img src="{{asset('storage/'.$empresarial->dirImagePortada)}}" style="width:100%; height: 240px;" alt="No se pudo cargar" /> <br />
							<div class="article-contenido"><a style="color: white;" href="{{route('empresarial.detail', $empresarial->titleUrl)}}">{{$empresarial->title}}</a></div>
						</div>
					</article>
				</div>
			@endforeach
