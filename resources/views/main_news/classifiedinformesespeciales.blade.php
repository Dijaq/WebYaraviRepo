					...
					<article>
						<div class="picture left" style="width:100%; position: relative;"> 
							...
							<div class="redes_etiqueta">
								<a target="_blank" href={{'https://www.facebook.com/sharer/sharer.php?u='.$urlServidor.'informeespecial/'.$informeespecial->titleUrl.'&amp;src=sdkpreparse'}} ><i style=" position: absolute; right: 5px; top: 5px;   text-align: center;">
