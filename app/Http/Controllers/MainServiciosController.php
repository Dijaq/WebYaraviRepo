...
class MainServiciosController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('maininformation.servicios.index', compact('publicidades', 'publicidadesPrincipal', 'labels', 'encuesta', 'tipo_go_publicidad'));
    }
