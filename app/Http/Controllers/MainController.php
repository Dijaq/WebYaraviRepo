...
//        $NoticiasPorTipo =  new \stdClass();
		...
		return view('main_news.home', compact('publicidades','publicidadesPrincipal', 'contentnews', 'new_principal', 'new_secundaria', 'labels', 'empresariales', 'encuesta', 'listaUltimasNoticias', 'listaNoticiasLocales', 'listaNoticiasPorTipo', 'urlServidor','maxvalueEncuesta','neworvideo','informesespeciales', 'tipo_go_publicidad'));
	}
    ...
    public function actualidadshow($idPrioridad)
    {
        ...
        return view('main_news.classifiedActualidad', compact('publicidadefs', 'publicidadesPrincipal','contentnews', 'new_principal', 'new_secundaria', 'labels', 'encuesta', 'listaUltimasNoticias', 'urlServidor'));
    }
     ...
     public function classifiedcampanias()
    {
        ...
        //$contentnews = News::with('contentnews')->get();
        $campanias = Campanias::where('estado', Config::get('constantes.estado_habilitado'))->orderBy('fechaPublicacion', 'desc')->paginate(Config::get('constantes.numero_noticias_clasificado_label'));
